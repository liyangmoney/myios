...
CREATE TABLE IF NOT EXISTS pis_procedure_document (
    id INT AUTO_INCREMENT PRIMARY KEY,
    document_code VARCHAR(50) NOT NULL UNIQUE COMMENT '文件编号 QMS-CX##-YYYY',
    document_name VARCHAR(200) NOT NULL COMMENT '文件名称',
    category_code VARCHAR(10) COMMENT '分类代码 C/M/S',
    department VARCHAR(100) COMMENT '主责部门',
    version VARCHAR(10) DEFAULT '2025' COMMENT '版本号',
    status VARCHAR(20) DEFAULT 'ACTIVE' COMMENT '状态：有效/废止/修订中',
