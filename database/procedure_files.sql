...
('QMS-CX40-2025', '工艺设计控制程序', 'M', 'M1', 0, '轨道技术研究院', '毛博士', '2025', 'ACTIVE', 'P1'),
('QMS-CX25-2025', '项目配置管理程序', 'M', 'M2', 0, '轨道技术研究院', '梁博士', '2025', 'ACTIVE', 'P1'),
('QMS-CX29-2025', '项目老化管理程序', 'M', 'M3', 0, '轨道技术研究院', '梁博士', '2025', 'ACTIVE', 'P1'),
('QMS-CX38-2025', '创新管理程序', 'M', 'M4', 0, '轨道技术研究院', '梁博士', '2025', 'ACTIVE', 'P1'),
('QMS-CX30-2025', '风险与机遇应对管理程序', 'M', 'M5', 0, '公司办公室', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX31-2025', '知识管理程序', 'M', 'M6', 0, '公司办公室', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX39-2025', '质量经济性管理程序', 'M', 'M7', 0, '财务部', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX35-2025', '不良质量成本管理办法', 'M', 'M8', 0, '财务部', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX02-2025', '过程评审控制程序', 'M', 'M9', 0, '品控中心', '陈怡', '2025', 'ACTIVE', 'P1'),
('QMS-CX34-2025', '预防和纠正措施控制程序', 'M', 'M10', 0, '品控中心', '陈怡', '2025', 'ACTIVE', 'P1'),
('QMS-CX07-2025', '员工能力矩阵管理程序', 'M', 'M11', 0, '人力资源部', '徐家璐', '2025', 'ACTIVE', 'P1'),
('QMS-CX36-2025', '员工培训管理程序', 'M', 'M12', 0, '人力资源部', '徐家璐', '2025', 'ACTIVE', 'P1'),
('QMS-CX37-2025', '设备和工装管理程序', 'M', 'M13', 0, '设备部', '戴娜', '2025', 'ACTIVE', 'P1'),
('QMS-CX41-2025', '监视和测量资源管理程序', 'M', 'M14', 0, '设备部', '戴娜', '2025', 'ACTIVE', 'P1'),
('QMS-CX42-2025', '业务连续性计划管理程序', 'M', 'M15', 0, '公司办公室', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX32-2025', 'FAI首件鉴定管理程序', 'M', 'M16', 0, '品控中心', '陈怡', '2025', 'ACTIVE', 'P1'),
('QMS-CX33-2025', '投标管理程序', 'M', 'M17', 0, '销售部', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX26-2025', '产品生产过程控制程序', 'S', 'S1', 0, '生产中心', '毛博士', '2025', 'ACTIVE', 'P1'),
('QMS-CX16-2025', '过程外包或转移策划程序', 'S', 'S2', 0, '生产中心', '毛博士', '2025', 'ACTIVE', 'P1'),
('QMS-CX24-2025', '供应商管理程序', 'S', 'S3', 0, '采购中心', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX27-2025', '产品交付管理程序', 'S', 'S4', 0, '销售部', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX28-2025', '售后活动管理程序', 'S', 'S5', 0, '销售部', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX22-2025', '采购控制程序', 'S', 'S6', 0, '采购中心', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX13-2025', 'EPPPS控制程序', 'S', 'S7', 0, '采购中心', '张敏琪', '2025', 'ACTIVE', 'P1'),
('QMS-CX10-2025', '产品检验和试验过程控制程序', 'S', 'S8', 0, '品控中心', '陈怡', '2025', 'ACTIVE', 'P1');
